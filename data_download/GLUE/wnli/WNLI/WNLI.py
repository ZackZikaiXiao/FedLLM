...
def generate_train_json_file():
    ...
    Data_path = "./data_download/GLUE/wnli/train.tsv"
    ...
    instruction_num = len(INSTRUCTIONS["WNLI"])
    data = []
    # count = 0
    for index, row in data_train.iterrows():
        ...
        instance["instruction"] = INSTRUCTIONS["WNLI"][instruction_index]
        ...
        #     print(data)
        #     break
    with open("./data_download/GLUE/wnli/WNLI/WNLI.json", 'w') as write_f:
...
def generate_test_json_file():
    # print(type(INSTRUCTIONS["sentiment"]))
    Data_path = "./data_download/GLUE/wnli/dev.tsv"
    data_train = pd.read_csv(
        Data_path,
        sep='\t',
        on_bad_lines="skip",
    ...
    for index, row in data_train.iterrows():
        ...
        #     print(data)
        #     break
    with open("./data_download/GLUE/wnli/WNLI/WNLI_test.json", 'w') as write_f:
        write_f.write(json.dumps(data, indent=4))
