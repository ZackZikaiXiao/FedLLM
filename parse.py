...
def parse_train_args():
    ...
    parser.add_argument('--dataset', type=str, default='sts-b', help='Dataset to use')
    parser.add_argument('--data_path', type=str, default='./data_download/GLUE/sts-b/STS-B', help='Data path')
    # if you want to change the dataset to train, please change the arguments here
...
def parse_eval_args():
    ...
    parser.add_argument("--lora_weights_path", type=str, default="./lora-shepherd-7b/rte dirichlet_quantity 3 10/8/adapter_model.bin", help="LoRA weights path")
    parser.add_argument("--lora_config_path", type=str, default="./lora-shepherd-7b/rte dirichlet_quantity 3 10", help="LoRA config path")
    # if you want to change the evaluation dataset, please modify the arguments here
