...
def parse_eval_args():
    ...
    parser.add_argument("--lora_weights_path", type=str, default="./lora-shepherd-7b/cola dirichlet_label 1 10/0/adapter_model.bin", help="LoRA weights path")
    parser.add_argument("--lora_config_path", type=str, default="./lora-shepherd-7b/cola dirichlet_label 1 10", help="LoRA config path")
    # if you want to change the evaluation dataset, please modify the arguments here
